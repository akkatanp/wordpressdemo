...
if ( ! function_exists( 'clean_education_site_branding' ) ) :
	 ...
	 *
	 * @uses get_transient, clean_education_get_theme_options, get_header_textcolor, get_bloginfo, set_transient, display_header_text
	...
	function clean_education_site_branding() {
		...
		$header_text = '
		<div id="site-header" ' . $class_header . '>
		...
		if ( has_custom_logo() ) {
			if ( $options['move_title_tagline'] ) {
				$output = '<div class="site-branding logo-right">' . $header_text . '<div id="site-logo">'. get_custom_logo() . '</div><!-- #site-logo -->';
			}
			else {
				$output = '<div class="site-branding logo-left">' . '<div id="site-logo">'. get_custom_logo() . '</div><!-- #site-logo -->' . $header_text;
			}
		}
