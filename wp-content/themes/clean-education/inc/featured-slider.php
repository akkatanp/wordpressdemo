	...
	function clean_education_demo_slider() {
		...
		<article class="post demo-image-1 hentry slides displayblock">
			...
			<div class="entry-container clear">
				...
				<div class="entry-summary">
					<p>Simple, Clean and Responsive theme focused on Corporate and Blog Websites.Download now and make your website look beautiful everywhere. <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
				</div>
			</div>
		</article><!-- .slides -->
		...
		<article class="post demo-image-2 hentry slides displaynone">
			...
			<div class="entry-container clear">
				...
				<div class="entry-summary">
					<p>We have a great line of support team and support forum. You do not need to worry about how to use the theme, just refer to our Support section <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
				</div>
			</div>
		</article><!-- .slides -->';
	}
