		...
		<article id="featured-post-1" class="post hentry post-demo">
			...
			<div class="entry-container">
				...
				<div class="entry-summary">
					<p>You can customize Featured Content from "Appearnace - Customize - Theme Options - Featured Content". <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
				</div>
			</div><!-- .entry-container -->
		</article>
