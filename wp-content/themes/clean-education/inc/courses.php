		...
		<div class="courses_slider_wrap">
			<article id="featured-post-1" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>Computer science courses covering topics in artificial intelligence, cyber security and software engineering.<span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>
			...
			<article id="featured-post-2" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>Creative arts courses provide you with knowledge on how the arts, entertainment, multimedia and fashion industries really work. <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>
			...
			<article id="featured-post-3" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>Engineering course enables you to develop engineering knowledge, skills, imagination & experience to the highest levels.<span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>';
		...
		if ( 'layout-four' == $options['courses_layout'] ) {
			...
			<article id="featured-post-4" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>Geography course focuses on geography includes classes covering areas of specialization within the field. <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>';
		}
		...
		<div class="courses_slider_wrap">
			<article id="featured-post-5" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>Education course focuses on developing critical skills to evaluate & analyse current research, theory & practice. <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>
			...
			<article id="featured-post-6" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>Our media course examines the relationships between media, culture & society in an increasingly globalised world. <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>
			...
			<article id="featured-post-7" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>Law is highly valued in all professions, and it\'s also the first step towards a career in the legal profession. <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>';
		...
		if ( 'layout-four' == $options['courses_layout'] ) {
			...
			<article id="featured-post-8" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>The key to understanding another society is mastering its language. The courses are also very flexible. <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div>
				</div><!-- .entry-container -->
			</article>';
		}
