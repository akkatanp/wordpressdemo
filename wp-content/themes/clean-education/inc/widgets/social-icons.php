...
/**
 * Adds Clean Education Social Icons widget.
 *
 * @since Clean Education 1.0
 */
class clean_education_social_icons_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Use this widget to add Social Icons Menu as a widget. ', 'clean-education' ) ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		if ( !$menus ) {
			echo '<p>'. sprintf( __('No menus have been created yet. <a href="%s">Create some</a>.', 'clean-education' ), admin_url('nav-menus.php') ) .'</p>';
			return;
		}
		?>
		<p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('nav_menu'); ?>"><?php _e( 'Select Menu:', 'clean-education' ); ?></label>
			<select id="<?php echo $this->get_field_id('nav_menu'); ?>" name="<?php echo $this->get_field_name('nav_menu'); ?>">
				<option value="0"><?php _e( '&mdash; Select &mdash;', 'clean-education' ); ?></option>
		<?php
