			...
			<article id="news-post-1" class="post hentry post-demo">
				...
				<div class="entry-container">
					...
					<div class="entry-summary">
						<p>You can edit/enable/disable News section from "Appearnace - Customize - Theme Options - News." <span class="readmore"><a href="#">' .  sprintf( esc_html__( '%s', 'clean-education' ) , $more_tag_text ) . '</a></span></p>
					</div><!-- .entry-summary -->
				</div><!-- .entry-container -->
			</article>
